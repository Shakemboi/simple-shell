 ...
 * @buf: parameter address of buffer
...
/**
 * get_input - a function which gets a line minus the newline
 * @info: parameter struct
 *
 * Return: the bytes read
 */
...
/**
 * _getline - a function that gets
 * next line of input from STDIN
 * @info: the given parameter struct
...
/**
 * sigintHandler - b function that locks ctrl-C
 * @sig_num: its the signal number
 *
 * Return: void
 */
