 ...
 * @num: the node index tha is beieng used by history
 *
 * Return: size of list
 */
 ...
 *
 * Return: 1 incase of success, 0 on failure
 */
...
/**
 * free_list - function frees all given nodes of a list
 * @head_ptr: its the address of pointer to head node
 *
 * Return: void
 */
