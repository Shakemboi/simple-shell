...
/**
 *struct argbundle - contains pseudo-arguments for a function
 *@argstr: string generated by getline
 *@argvstr: string array gotten from user input
 *@path: path of current argument string
 *@argc_no: count of arguments
 *@line_tt: count of errors
 *@error_no: exit()s error code
 *@counter_line: the count of lines in each output
 *@filename: filename of program
 *@envcpy: linked list local environ copy
 ...
 *@numhist: it tracks the history line number count
 */
...
/**
 * struct built - a func that has builtin string and related function
 * @cmd: flag of bulitin command
 * @handler: the function
 */
