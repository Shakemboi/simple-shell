...
/**
 * strenv - strings arrays for environ is returned
...
/**
 * rmsetenv - eliminates env variable
 * @d_typeinfo: struct with args, mntn con func prototype
 * @varbl: parameter of env variable string
 *
...
/**
 * setenvset - func to give value to new env variable
 *             function to manipulate or mod already existing env varbl
 * @d_typeinfo: struct with args, mntn con func prototype
 * @varbl: parameter of the current env varbl string
 * @val: value
 *
