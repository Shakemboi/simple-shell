...
/**
 * find_builtin - func that finds a builtin command
 * @info: the parameter & return info struct
 *
 * Return: -1 incase builtin not found,
 * 0 incase builtin executed successfully,
 * 1 incase builtin found but not successful,
 * 2 incase builtin signals exit()
 */
...
/**
 * find_cmd - a func to find a command in PATH
 * @info: the parameter & return info struct
 *
 * Return: void
 */
